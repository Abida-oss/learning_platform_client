    ...
    return (
        <div>
            ...
            <Link className="btn btn-ghost normal-case text-xl">Coursera</Link>
                ...
                <Link to='' className="btn btn-ghost normal-case text-xl">{user?.photoURL ? <img alt='' className="w-10 rounded-full" src={user?.photoURL} title={user.displayName} /> : <FaUserAlt></FaUserAlt>}</Link>
            </div>
